...
const validateMatchingPasswords = () => {
    if (nuevaContraseña.value !== confirmarContraseña.value) {
        setError("Las contraseñas no coinciden", confirmarContraseña);
    } else {
        setError("", confirmarContraseña, false);
    }
}
...
nuevaContraseña.addEventListener("blur", (e) => validateEmptyField("Ingresa por favor tu nueva contraseña", e));
confirmarContraseña.addEventListener("blur", validateMatchingPasswords);
